...
<form method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    <label class="col-4">Are you an individual applicant or from any company/organisation? <br><i>Adakah anda pemohon secara individu atau dari syarikat/organisasi?</i></label> 
    <div class="col-8">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="nameconperson" name="nameconperson" type="text" class="form-control">
      </div>
    </div>
  </div>
  <div class="form-group row">
    <label for="emailaddconperson" class="col-4 col-form-label">Email Address of Contact Person at Ain Medicare Sdn Bhd<br><i>Alamat email orang yang dihubungi di Ain Medicare Sdn Bhd</i></label> 
    <div class="col-8">
      <div class="input-group">
        <div class="input-group-prepend">
          <div class="input-group-text">
...
<div class="form-group">
<label align="justify">B. Please declare if you or any family member staying with you have been travelling to the COVID-19 red zone / MCO / EMCO / CMCO areas within 14 days of the declaration. <br><i>B. Sila nyatakan jika anda atau mana-mana ahli keluarga yang tinggal bersama anda telah pergi ke / dari kawasan zon merah COVID-19 / PKP / PKPD / PKPB dalam masa 14 hari dari pengisytiharan ini.</i></label> 
    <div>
      <div class="custom-control custom-radio custom-control-inline">
...
<hr>
  ...
  <div class="form-group row">
    ...
    <div class="btn-group btn-group-toggle" data-toggle="buttons">
  <label class="btn btn-secondary">
    <input type="radio" name="fever" id="option1" autocomplete="off" value="Yes" required> Yes
  </label>
  <label class="btn btn-secondary">
 ...
 */
      ...
      Working Address: $caddress, $ccity, $cstate
