  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <div class="input-group">
        ...
        <option value="">Select Visiting Office</option>
 ...
 */
      ...
      Salam and greetings. <br><br>

      

      A Health Declaration Form has been submitted for Reference No. : $refnum. Form can be viewed in the link below. Please be noted to login prior reviewing. <br><br>
      ...
      MyKad / Passport No.: $mykad <br>

      Date of Entry: $entryin until $entryout <br>

      Company / Department: $company <br>

      Working Address: $caddress, $ccity, $cstate <br>

      Telephone Number: $telno <br>

      Reason of Entry: $reasonentry <br>

      Status: Pending Approval <br><br>



      https://hdform.ainmedicare.com.my/manageappl.php?view_id=$refnum <br><br>
      ...
      A Health Declaration Form has been submitted for Reference No. : $refnum. 
      ...
      smtpmailer($tohr1, $from, $name, $subject, $message); // internal - hr

      smtpmailer($tohr2, $from, $name, $subject, $message); // internal - hr

      smtpmailer($to2, $from, $name, $subject, $message2); // internal - pic

      smtpmailer($to1, $from, $name, $subject, $message2); // internal - applicant
